##############################################################################
# Module:  FX_RunWinCmd_WSMan_QuickConfig
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_RunWinCmd_WSMan_QuickConfig = $true, $false, $true, 'System', 'FX_RunWinCmd_WSMan_QuickConfig', $false, @(); }


function FX_RunWinCmd_WSMan_QuickConfig([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
  ...
  $PsExecPayLoad  = "`"winrm.cmd quickconfig -quiet`""
