##############################################################################
# Module:  FX_RunWinCmd_WSMan_ClientPolicy_TrustNoHosts
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_RunWinCmd_WSMan_ClientPolicy_TrustNoHosts = $true, $false, $true, 'System', 'FX_RunWinCmd_WSMan_ClientPolicy_TrustNoHosts', $false, @(); }


function FX_RunWinCmd_WSMan_ClientPolicy_TrustNoHosts([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
