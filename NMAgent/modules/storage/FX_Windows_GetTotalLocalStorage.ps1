##############################################################################
# Module:  FX_Windows_GetTotalLocalStorage.ps1
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetTotalLocalStorage = $true, $false, $true, 'System', 'FX_Windows_GetTotalLocalStorage', $false, @(); }


function FX_Windows_GetTotalLocalStorage([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
