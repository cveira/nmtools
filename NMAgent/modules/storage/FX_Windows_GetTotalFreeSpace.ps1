##############################################################################
# Module:  FX_Windows_GetTotalFreeSpace.ps1
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetTotalFreeSpace = $true, $false, $true, 'System', 'FX_Windows_GetTotalFreeSpace', $false, @(); }


function FX_Windows_GetTotalFreeSpace([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
