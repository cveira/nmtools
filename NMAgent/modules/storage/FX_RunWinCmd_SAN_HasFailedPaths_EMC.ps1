##############################################################################
# Module:  FX_RunWinCmd_SAN_HasFailedPaths_EMC
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_RunWinCmd_SAN_HasFailedPaths_EMC = $true, $false, $true, 'System', 'FX_RunWinCmd_SAN_HasFailedPaths_EMC', $false, @(); }


function FX_RunWinCmd_SAN_HasFailedPaths_EMC([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
