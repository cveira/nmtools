##############################################################################
# Module:  FX_Windows_GetTotalSANStorage_ByDevice.ps1
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetTotalSANStorage_ByDevice = $true, $false, $true, 'System', 'FX_Windows_GetTotalSANStorage_ByDevice', $false, @(); }


function FX_Windows_GetTotalSANStorage_ByDevice([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
