##############################################################################
# Module:  PLEX_RunWinCmd_DSGridServer_AgentUnInstall
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ PLEX_RunWinCmd_DSGridServer_AgentUnInstall = $true, $false, $true, 'System', 'PLEX_RunWinCmd_DSGridServer_AgentUnInstall', $false, @(); }


function PLEX_RunWinCmd_DSGridServer_AgentUnInstall([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
