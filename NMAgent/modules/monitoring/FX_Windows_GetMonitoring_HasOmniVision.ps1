##############################################################################
# Module:  FX_Windows_GetMonitoring_HasOmniVision
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetMonitoring_HasOmniVision = $true, $false, $true, 'System', 'FX_Windows_GetMonitoring_HasOmniVision', $false, @(); }


function FX_Windows_GetMonitoring_HasOmniVision([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
