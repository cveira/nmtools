##############################################################################
# Module:  FX_RunUnixCmd_GetMonitoring_HasMeasureWare
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_RunUnixCmd_GetMonitoring_HasMeasureWare = $true, $false, $true, 'System', 'FX_RunUnixCmd_GetMonitoring_HasMeasureWare', $false, @(); }


function FX_RunUnixCmd_GetMonitoring_HasMeasureWare([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
