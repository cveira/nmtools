##############################################################################
# Module:  FX_Windows_GetMonitoring_HasWVA
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetMonitoring_HasWVA = $true, $false, $true, 'System', 'FX_Windows_GetMonitoring_HasWVA', $false, @(); }


function FX_Windows_GetMonitoring_HasWVA([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
