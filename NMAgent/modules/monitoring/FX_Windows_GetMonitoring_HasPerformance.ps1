##############################################################################
# Module:  FX_Windows_GetMonitoring_HasPerformance
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetMonitoring_HasPerformance = $true, $false, $true, 'System', 'FX_Windows_GetMonitoring_HasPerformance', $false, @(); }


function FX_Windows_GetMonitoring_HasPerformance([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
