##############################################################################
# Module:  FX_Windows_GetMonitoring_HasTivoli
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ FX_Windows_GetMonitoring_HasTivoli = $true, $false, $true, 'System', 'FX_Windows_GetMonitoring_HasTivoli', $false, @(); }


function FX_Windows_GetMonitoring_HasTivoli([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
