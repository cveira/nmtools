##############################################################################
# Module:  FX_OpenSLIM_Windows_GetHbaLinksInfo
# Version: 4.54b0
# Date:    2010/12/11
...
$script:LibraryModules += @{ HbaLinksInfo = $true, $true, $false, 'System', 'FX_OpenSLIM_Windows_GetHbaLinksInfo', $false, @(); }


function FX_OpenSLIM_Windows_GetHbaLinksInfo([bool] $SetConnectToHostByIP, [string] $NodeName, [string] $NodeIP, [string] $PropertyName, [bool] $IsSupported, [bool] $IsString) {
